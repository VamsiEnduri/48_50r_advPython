...
data = {
    ...
    "student_join_date": [
        "2024-06-01"] * 20   # same date for all students
}
...
#one cilumn selecting'
# print(df["name"])
#multiple column
# print(df[["name","scholarship"]]) # 

# print(df.loc[4,["scholarship","name","city"]])
# print(df.loc[4])

# print(df.loc((df["scholarship"]==1)))

# print(df.loc[(df["age"]>=17) & (df["city"]=="Hyderabad") & (df["scholarship"]==0)])

# print(df.loc[((df["age"]>=17) & (df["city"]=="Hyderabad")) & (df["scholarship"]==0)])

# print(df.iloc[0:11,2:5])
# print(df.iloc[-1])

# print(df.iloc[[0,7,17,19],[0,2,5]])

# print(df.loc[df["scholarship"]==0])

# print(df["scholarship"]==1)
# print(df["age"]>=15)
# math()


# print(df.query("age>=17 and city in ('Hyderabad','Mumbai')"))

# print(df[df["city"].isin(["Mumbai","Hyderabad"])])

# print(df)
df["student_join_date"]=pd.to_datetime(df["student_join_date"])
print(df["student_join_date"])
df["year"]=df["student_join_date"].dt.year #2025-10-5
df["month"]=df["student_join_date"].dt.month #2025-10-5
df["day"]=df["student_join_date"].dt.day #2025-10-5
df["day_name"]=df["student_join_date"].dt.day_name() #2025-10-5
print(df)